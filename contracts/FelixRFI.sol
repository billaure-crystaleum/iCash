...
contract FelixRFI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Felix RFI";
    string private constant _symbol = "FELIX_RFI";
    ...
    constructor(address payable _marketingWallet, address payable _teamPoolWallet) {
        ...
        excludeFromReward(address(_teamPoolWallet));
